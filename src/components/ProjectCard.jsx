  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Model Container */}
        <div
          className={`${index % 2 === 1 ? "lg:order-1" : "lg:order-2"} relative w-full h-[400px] rounded-2xl overflow-hidden group-hover:shadow-2xl transition-all duration-700`}
        >
          {/* Overlay */}
          <div
            className={`absolute inset-0 bg-zinc-900/0 group-hover:bg-zinc-900/10 transition-all duration-500`}
          />
          ...
          {/* Floating details */}
          <div
            className={`absolute bottom-6 left-6 right-6 transform ${
          ...
          {/* Corner accent */}
          <div
            className={`absolute top-4 right-4 w-3 h-3 rounded-full bg-emerald-400 transform ${
